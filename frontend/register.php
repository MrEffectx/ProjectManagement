                            ...
                            <form method="post" class="user">
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text" class="form-control form-control-user" name="prenom" placeholder="Pr̩nom">
                                    </div>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <input type="phone" class="form-control form-control-user" name="tel" placeholder="T̩l̩phone portable">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="idCard" class="form-control form-control-user" name="numci" placeholder="Num̩ro carte identit̩">
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
